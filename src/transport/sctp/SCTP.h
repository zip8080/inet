...
class INET_API SCTP : public cSimpleModule
{
    ...
    public:
        ...
        */
        ...
        void addLocalAddress(SCTPAssociation *conn, Address address);
        void addLocalAddressToAllRemoteAddresses(SCTPAssociation *conn, Address address, std::vector<Address> remAddresses);
        void addRemoteAddress(SCTPAssociation *conn, Address localAddress, Address remoteAddress);
        void removeLocalAddressFromAllRemoteAddresses(SCTPAssociation *conn, Address address, std::vector<Address> remAddresses);
        void removeRemoteAddressFromAllConnections(SCTPAssociation *conn, Address address, std::vector<Address> locAddresses);
        /**
