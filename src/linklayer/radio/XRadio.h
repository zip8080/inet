...
#ifndef __INET_XRADIO_H
#define __INET_XRADIO_H
 ...
 *
 */
class INET_API XRadio : public ChannelAccess, public IPowerControl
{
  public:
    XRadio();
    virtual ~XRadio();
  ...
  protected:
    ...
    void bufferMsg(XAirFrame *airframe);
  ...
  protected:
    ...
    /** Transmit range [meter] */
    double transmitRange;

    /** Transmit as noise range [meter] */
    double transmitAsNoiseRange;
